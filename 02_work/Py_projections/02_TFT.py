...
validation = TimeSeriesDataSet.from_dataset(
    ...
    min_prediction_idx=2019,  # prediction windows begin in 2019
    max_prediction_length=3,  # again, 3 steps (2019→2021)
)
...
with open("/home/v18y97/mt_pop_forecast/test_study.pkl", "wb") as fout:
...
df_long.to_csv("/home/v18y97/mt_pop_forecast/tft_test_2022-2024.csv", index=False)